...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_ThorSet p_ThorSet;
        ...
        public static SteamVR_Input_ActionSet_ThorSet ThorSet
        {
            get
            {
                return SteamVR_Actions.p_ThorSet.GetCopy<SteamVR_Input_ActionSet_ThorSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_ThorSet = ((SteamVR_Input_ActionSet_ThorSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_ThorSet>("/actions/ThorSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.ThorSet};
        }
    }
}
